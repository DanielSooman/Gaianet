...
while true; do
    clear
    echo "==============================================================="
    echo -e "\e[1;36m🚀🚀 GAIANET NODE INSTALLER Tool-Kit BY Daniel Sooman 🚀🚀\e[0m"

    echo -e "\e[1;85m📢 Stay updated:\e[0m"
    echo -e "\e[1;85m🔹 Telegram: https://t.me/danielsooman\e[0m"
    echo -e "\e[1;85m🔹 X (Twitter): https://x.com/danielsooman\e[0m"
